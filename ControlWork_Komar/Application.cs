...
namespace ControlWork_Komar
{
    public class Application
    {
        ...
        public Application()
        {
            ...
            autosaveTimer = new Timer(Print_time, null,0,10000);
        }

        public void Print_time(object sender)
        {
       ...
       //     TmpUsers = MyFile.LoadUsersFromFile("UserDetails.json");
       //     bool flag = true;
       //     foreach (var u in Users)
       //     {
       //         foreach (var t in TmpUsers)
       //         {
       //             if (u != t)
       //             {
       //                 flag = false;
